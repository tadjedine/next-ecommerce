...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F172A] text-white pt-20 pb-8 border-t border-border-soft/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Column 2: Shop */}
          <div>
            <h3 className="font-bold text-lg mb-6 tracking-wide">{t("nav.shop")}</h3>
            <ul className="space-y-4">
              <li><Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors">New Arrivals</Link></li>
              <li><Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors">Best Sellers</Link></li>
              <li><Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors">Sale</Link></li>
              <li><Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors">All Products</Link></li>
              <li><Link href="/shop" className="text-white/60 hover:text-white text-sm transition-colors">Gift Cards</Link></li>
            </ul>
          </div>
